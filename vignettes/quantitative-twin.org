...
#+NAME: scatter1
#+BEGIN_SRC R :exports both :results output graphics :file scatter1.jpg 
...
#+NAME: scatter2
#+BEGIN_SRC R :exports both :results output graphics :file scatter2.jpg
...
#+NAME: marg1
#+BEGIN_SRC R :exports both :results output graphics :file marg1.jpg
	  dm <- Expand(twinbmi,
		      bmi=0,
		      gender=c("male"),
