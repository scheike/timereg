...
Warning message:
S3 method ‘plot.onf.region’ was declared in NAMESPACE but not found
id: 1
...
We now generate recurrent events with two types of events. Here we generate data
where the survivors have dependent number of events of type "1" and "2"
