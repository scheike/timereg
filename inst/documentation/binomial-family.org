...
#+RESULTS[3252fee6a681341a232b922a88bd513436dffc63]:
#+begin_example
...
#+RESULTS[7e6df4e6b9b6e70d2fe0d28f67e3ce88f4dc5011]:
#+begin_example
...
#+RESULTS[a024cf7f129a2c09da3c73870d0932f17c840b5a]:
#+begin_example
      [,1] [,2]
 [1,] 0.25    0
 [2,] 0.25    0
...
#+RESULTS[4a5e65da4df7407618c182dfa61a5fc2096fa37f]:
#+begin_example
...
#+RESULTS[968f9b1d41759a965b5232f2fbc400bbf7a1f3cb]:
#+begin_example
...
#+RESULTS[b580e9c0e1bbdb103203c640592cdaa3479db3fa]:
: Dependence parameter for Clayton-Oakes model
: Variance of Gamma distributed random effects 
...
#+RESULTS[4e436dec86f83ce0c362d6ad91332d92080212fd]:
: Dependence parameter for Clayton-Oakes model
: Variance of Gamma distributed random effects 
: Error in theta.des %*% theta : non-conformable arguments
...
#+RESULTS[3cb068f93a09f8d4c35756a55cd039831e40fae0]:
#+begin_example
     [,1] [,2]
[1,]    1    2
[2,]    1    3
...
#+RESULTS[8b7b5d3d50572f8e7b6b96dab16a07e757f95da9]:
: Dependence parameter for Clayton-Oakes model
: Variance of Gamma distributed random effects 
: Error in theta.des %*% theta : non-conformable arguments
...
#+RESULTS[8842bcbd5f02e47f310c80bcb550bde7e687ff0d]:
#+begin_example
     [,1] [,2]
[1,]    1    2
[2,]    1    3
...
#+RESULTS[540a9c1517a07e98f9ddaa0a903fa669ab15e9c5]:
#+begin_example
     [,1] [,2] [,3] [,4]
[1,]    1    0    1    0
[2,]    0    1    1    0
...
#+RESULTS[3139460f1ee4512f91238e7da86313f3ec0531dd]:
: Dependence parameter for Clayton-Oakes model
: Variance of Gamma distributed random effects 
: Error in theta.des %*% theta : non-conformable arguments
...
#+RESULTS[201894d9f2f4361fdc3726cbe9569fb13bef02a0]:
#+begin_example
...
#+RESULTS[82d7b588dd9499ab764b04b343b0dac691138bfa]:
: Dependence parameter for Clayton-Oakes model
: Variance of Gamma distributed random effects 
: Error in theta.des %*% theta : non-conformable arguments
...
#+RESULTS[4fe6fd0df00e4ac058fd54f0e6145da623d1ce57]:
#+begin_example
type1 #levels=:3 
...
#+RESULTS[9d148df270fb3a29a167821a085d9e120d41c1ce]:
#+begin_example
