...
#+NAME: scatter1
#+BEGIN_SRC R :exports both :results output graphics :file scatter1.png 
...
#+NAME: scatter2
#+BEGIN_SRC R :exports both :results output graphics :file scatter2.png
...
#+NAME: marg1
#+BEGIN_SRC R :exports both :results output graphics :file marg1.png
	  dm <- Expand(twinbmi,
		      bmi=0,
		      gender=c("male"),
