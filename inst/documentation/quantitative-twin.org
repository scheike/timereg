...
#+NAME: scatter1
#+BEGIN_SRC R :exports both :results output graphics :file figs/scatter1.png 
  mz <- log(subset(twinwide, zyg=="MZ")[,c("bmi1","bmi2")])
  scatterdens(mz)
#+END_SRC

#+RESULTS: scatter1
[[file:figs/scatter1.png]]
...
#+NAME: scatter2
#+BEGIN_SRC R :exports both :results output graphics :file figs/scatter2.png
  dz <- log(subset(twinwide, zyg=="DZ")[,c("bmi1","bmi2")])
  scatterdens(dz)
#+END_SRC

#+RESULTS: scatter2
[[file:figs/scatter2.png]]

#+BEGIN_marginfigure
#+CAPTION: Scatter plot of logarithmic BMI measurements in DZ twins. label:fig:scatter2
#+ATTR_LATEX: :width \textwidth :float nil :center t#+END_marginfigure
...
#+NAME: marg1
#+BEGIN_SRC R :exports both :results output graphics :file figs/marg1.png
	  dm <- Expand(twinbmi,
		      bmi=0,
		      gender=c("male"),
...
#+RESULTS:
: Error in estimate.multigroup(mg, ...) : 
...
#+RESULTS:
: Error in estimate(l, contr(5:6, 6)) : object 'l' not found
