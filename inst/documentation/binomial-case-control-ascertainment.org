...
#+RESULTS[c3fb5ee93d0be3ee5590c20aa3e1281564d1618a]:
#+begin_example
...
#+RESULTS[f3318d5681b780d4438c0320fb02087b04f9fadf]:
#+begin_example
Dependence parameter for Odds-Ratio (Plackett) model 
With log-link 
$estimates
...
#+RESULTS[e1d7096ecb3cb7555111fba243ea5435a1dfbd02]:
#+begin_example
     [,1] [,2]
[1,]    6    5
[2,]   22   21
...
#+RESULTS[62fb48d46a4ab954ee6af6d69c67194bd49cc40f]:
#+begin_example
Dependence parameter for Clayton-Oakes model
Variance of Gamma distributed random effects 
$estimates
                theta         se
dependence1 0.8572081 0.09509316
...
$vartot
   Estimate Std.Err  2.5% 97.5%  P-value
p1    0.857  0.0951 0.671  1.04 1.98e-19
...
#+RESULTS[8d60869115499564dea360fca115d41ea5608bb9]:
#+begin_example
Dependence parameter for Clayton-Oakes model
Variance of Gamma distributed random effects 
$estimates
