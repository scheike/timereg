...
#+NAME: scatter1
#+BEGIN_SRC R :exports both :results output graphics :file fig/scatter1.png 
...
#+RESULTS: scatter1
[[file:fig/scatter1.png]]

#+END_marginfigure


#+NAME: scatter2
#+BEGIN_SRC R :exports both :results output graphics :file fig/scatter2.png
...
#+NAME: marg1
#+BEGIN_SRC R :exports both :results output graphics :file fig/marg1.png
	  dm <- Expand(twinbmi,
		      bmi=0,
		      gender=c("male"),
