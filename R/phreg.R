...
##' @export
plot.predictphreg  <- function(x,se=FALSE,add=FALSE,ylim=NULL,xlim=NULL,
    lty=NULL,col=NULL,type=c("surv","cumhaz"),ylab=NULL,xlab=NULL,
...
###  if (legend & (!add)) 
###  graphics::legend(where,legend=legend,col=cols[,1],lty=ltys[,1])
