cor.cifL<-function(cif,data=sys.parent(),cause,cif2=NULL,times=NULL,
...
multi=0; dscore <- 1;  trunkp <- 1; stab.cens=FALSE; entry.call <- NULL; 
...
if (cause1!=attr(cif,"causeS")) cat("Cause for marginal model and correlation model not the same\n"); 
...
rr.cifL<-function(cif,data=sys.parent(),cause,cif2=NULL,times=NULL,
cause1=1,cause2=1,cens.code=0,cens.model="KM",Nit=40,detail=0,
clusters=NULL,theta=NULL,theta.des=NULL,parfunc=NULL,dparfunc=NULL,
step=1,sym=0,colnames=NULL,dimpar=NULL,weights=NULL,notaylor=1,
same.cens=FALSE,censoring.probs=NULL,silent=1,
...
{ ## {{{
## {{{ set up data and design
 multi=0; dscore=0; stab.cens <- FALSE
...
or.cifL<-function(cif,data=sys.parent(),cause,cif2=NULL,times=NULL,
cause1=1,cause2=1,cens.code=0,cens.model="KM",Nit=40,detail=0,
clusters=NULL,theta=NULL,theta.des=NULL, parfunc=NULL,dparfunc=NULL,
step=1,sym=0,colnames=NULL,dimpar=NULL,weights=NULL,notaylor=1,
same.cens=FALSE,censoring.probs=NULL,silent=1,
entry=NULL,estimator=1,trunkp=1)
{ ## {{{
## {{{ set up data and design
 multi=0; dscore <- 1;  stab.cens <- FALSE
 # trans=1 P_1=1-exp(- ( x' b(b)+ z' gam t) ), 
 formula<-attr(cif,"Formula"); 
 ldata<-aalen.des(formula,data,model="aalen");
 X<-ldata$X; time<-ldata$time2; Z<-ldata$Z;  status<-ldata$status;
